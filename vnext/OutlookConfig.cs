namespace OutlookWelkinSync
{
    ...
    public class OutlookConfig
    {
        ...
        {
            this.ClientId = Environment.GetEnvironmentVariable("OutlookClientId");
            this.ClientSecret = Environment.GetEnvironmentVariable("OutlookClientSecret");
            this.Tenant = Environment.GetEnvironmentVariable("OutlookTenant");
        }
    }
}